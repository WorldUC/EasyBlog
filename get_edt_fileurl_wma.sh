...
#sed -n '/附件【/{s,^.*UploadFiles,,; s,\.wma.*$,,; s,^,www.worlduc.com/UploadFiles,; s,\\,/,g; s,$,.wma,; p;}' tmp0.txt  
sed -n '/<div id="divAttachment" class="attachment ">/{s/^.*href=.//; s/\.wma.*$/.wma/; s,^,www.worlduc.com,;p;q;}' tmp0.txt
